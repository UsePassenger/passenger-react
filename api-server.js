...
app.get('/', function (req, res) {
  ...
  var hello;
  var filteredRouteEventPairs = routeEventPairs.filter(function (_ref) {
    var departure = _ref.departure;
    var destination = _ref.destination;

    return departure.stationName.toLowerCase() === dep.toLowerCase() && destination.stationName.toLowerCase() === dest.toLowerCase();
  });
